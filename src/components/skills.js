    ...
    constructor() {
        ...
        this.state = {
            skills: [
                ...
                { title: 'SQL', level: 55, category: { 'Back End': true, 'Control Systems': true }},
                { title: 'NodeJS', level: 75, category: { 'Back End': true }},
                { title: 'Express', level: 85, category: { 'Back End': true }},
                { title: 'Python', level: 90, category: { 'Back End': true, 'Control Systems': true  }},
                { title: 'VB.Net', level: 65, category: { 'Back End': true, 'Control Systems': true }},
                { title: 'C++', level: 60, category: { 'Back End': true }},
                { title: 'Gulp / Webpack', level: 60, category: { 'Front End': true, 'Back End': true, } },
