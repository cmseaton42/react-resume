...
export default class Profile extends Component {
    constructor() {
        ...
        this.state = {
            about_me: `My name is Canaan Seaton. I currently make my home in Evansville, IN where I work as a Control Systems Engineer. From a young age,
            I have been fascinated with problem solving, making it my ambition to chase down those problems that people view as difficult.  In high school, this 
            manifested itself in teaching myself higher level math when the school's standard curriculm had been exhausted. Now this desire to learn and grow, manifests itself in 
